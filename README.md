# @anarion80's QMK keymap

![ZSA Voyager](doc/voyager.jpg)

This is my [Quantum Mechanical Keyboard (QMK)](https://docs.qmk.fm) keymap for
the ZSA Moonlander, and ZSA Voyager keyboards. It is based on Pascal Getreuer's layout and repo.
...
Here is a visualization of my keymap. See [anarion.c](anarion.c) for full
details.

![Layout image](doc/anarion_voyager.png)
...
2. Clone this repo locally
   ...
   ```sh
   git clone --recurse-submodules https://github.com/anarion80/qmk-keymap
   ```
...
# ZSA Voyager
qmk flash -kb zsa/voyager -km anarion
```
